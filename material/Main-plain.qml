        ...
        Component {
            ...
            */
            ...
            Flickable {
                ...
                anchors {
                    fill: parent
                    topMargin: pageHeader.height + units.gu(10)
                    bottomMargin: units.gu(5)
                    horizontalCenter: parent.horizontalCenter

                }
                width: parent.width
                contentHeight: addGame.height + previousGames.height + otherOptions.height + units.gu(10)
                ...
                Column {
                    ...
                    Text {
                        anchors.horizontalCenter: parent.horizontalCenter
                        text: i18n.tr("Accepted formats: .atr, .com, .dat, .l9, .sna, .st")
                        wrapMode: Text.WrapAtWordBoundaryOrAnywhere
                ...
                Column {
                    ...
                    FolderListModel {
                        ...
                        nameFilters: [ "*.sna", "*.dat", "*.l9", "*.st", "*.atr", "*.com", "*.SNA", "*.DAT", "*.L9", "*.ST", "*.ATR", "*.COM" ]
                        showHidden: true
                        showDirs: false
                        //sortField: Name
                    ...
                    Component {
                        ...
                        Row {
                            ...
                            Icon { width: units.gu(3); height: width; name: "voicemail"; anchors.verticalCenter: parent.verticalCenter
                                MouseArea {anchors.fill: parent;onClicked: mainPageStack.push(Qt.resolvedUrl("playLevel9.qml"),{"game": filePath})}
                            }
                ...
                Column {
                    ...
                    ListItem{
                        ...
                        divider.visible: true
                        GelekItemLayout {
                            title.text: i18n.tr("Level 9 Games Stories")
                        }
                        onClicked: {
                            Qt.inputMethod.hide();
