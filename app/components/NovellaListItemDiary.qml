...
ListItem {
	...
	Row {
		...
		Text { text: chapterNumber;  font.bold: true; font.pixelSize: units.gu(2.5); color: darkColor; anchors.verticalCenter: parent.verticalCenter; clip: true; width: parent.width; wrapMode: Text.WrapAtWordBoundaryOrAnywhere; horizontalAlignment: Text.AlignHCenter}
	}
