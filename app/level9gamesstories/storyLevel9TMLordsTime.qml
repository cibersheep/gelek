        ...
        Column{
            ...
            Column {
                ...
                UbuntuShape {
                    ...
                    aspect: UbuntuShape.Flat
                    source: Image {
                        source: "../../../../graphics/tnm-lot-01.png"
                    }
                }
            ...
            Column {
                ...
                LevelLabel { text: i18n.tr("Hints for <i>Lords of Time</i>") }
                LevelText { text: i18n.tr("• You need to enter the clock; nine time zones can be reached from here."); width: parent.width - marginColumn * 2 }
                LevelText { text: i18n.tr("• Tackle the time zones in numeric order most of the time."); width: parent.width - marginColumn * 2 }
                LevelText { text: i18n.tr("• After each of the first eight zones, you can always get back to the clock."); width: parent.width - marginColumn * 2 }
                LevelText { text: i18n.tr("• You score points for each of the nine ingredients and for each of the 18 treasures collected. There are a few bonuses."); width: parent.width - marginColumn * 2 }
            ...
            Column {
                ...
                LevelText { text: "Mike Austin" }
                LevelText {
                    text: i18n.tr("A-code Compiler and System:")
                    color: lightColor
                }
                LevelText { text: "Mike Austin" }
                LevelText {
                ...
                LevelText { text: "Pete Austin" }
                LevelText {
                    text: i18n.tr("Additional Expertise:")
                    color: lightColor
                }
                LevelText { text: "Ian Buxton" }

                LevelText {
                    text: i18n.tr("Instruction Booklet:")
                    color: lightColor
                }
                LevelText { text: "Pete Austin" }

                LevelText {
                    text: i18n.tr("Artwork:")
                    color: lightColor
                }
                LevelText { text: "Tim Noyce" }
