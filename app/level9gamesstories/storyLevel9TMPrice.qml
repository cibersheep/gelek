        ...
        Column{
            ...
            Column {
                ...
                UbuntuShape {
                    ...
                    aspect: UbuntuShape.Flat
                    source: Image {
                        source: "../../../../graphics/tnm-lot-pom-01.jpg"
                    }
                }
            ...
            Column {
                ...
                LevelLabel { text: i18n.tr("Hints for <i>Price of Magik</i>") }
                LevelText { text: i18n.tr("• Tackle the outdoor locations before entering the house."); width: parent.width - marginColumn * 2 }
                LevelText { text: i18n.tr("• The HYP (hypnosis) spell lets you command one creature at a time. To give an order, key in instructions such as BAT, TAKE THE FELDSPAR."); width: parent.width - marginColumn * 2 }
                LevelText { text: i18n.tr("• You score points for learning and using spells, and for reaching a few inaccessible places."); width: parent.width - marginColumn * 2 }
            ...
            Column {
                ...
                LevelText { text: "Margaret Austin" }
                LevelText {
                    text: i18n.tr("Original Idea:")
                    color: lightColor
                }
                LevelText { text: "David Williamson" }
                LevelText {
