            ...
            function updateModels() {
                ...
                for (var i=0; i< savedGamesModel.count; ++i) {
                    ...
                    if (savedGamesModel.get(i, "fileName") !== "gelekSaveList") {
                        ...
                        //console.log("categorizedGames " + i +":" + categorizedSavedGamesModel.get(i).category + " fileName: " + categorizedSavedGamesModel.get(i).fileName + " filePath: " + categorizedSavedGamesModel.get(i).filePath)
                    }
                ...
                //Sort Model by Section
                for (var i=0; i<count; i++) {
                    for (var j=0; j<i; j++) {
                        if (categorizedSavedGamesModel.get(i).category === categorizedSavedGamesModel.get(j).category) {
                            categorizedSavedGamesModel.move(i,j,1)
                            break
                        }
                    }
                ...
                sectionNumber = 0
                for (var k=1; k<categorizedSavedGamesModel.count; k++) {
                    if (categorizedSavedGamesModel.get(k).category !== categorizedSavedGamesModel.get(k-1).category)
                        sectionNumber += 1
                }
                console.log("Model Sorting Finished with " + sectionNumber + " Sections")
